...
public protocol StateObserver: AnyObject {
    func stateDidUpdate(_ state: M640GKitPumpManagerState, _ oldState: M640GKitPumpManagerState)
    func deviceScanDidUpdate(_ device: DanaPumpScan)
}

public class M640GKitPumpManager: DeviceManager {
    private(set) var bluetooth: BluetoothManager

    private var oldState: M640GKitPumpManagerState
    public var state: M640GKitPumpManagerState
    ...
    init(state: M640GKitPumpManagerState, dateGenerator _: @escaping () -> Date = Date.init) {
        self.state = state
        oldState = M640GKitPumpManagerState(rawValue: state.rawValue)
        M640GKitEncryption.setEnhancedEncryption(state.encryptionMode)
    ...
    public required convenience init?(rawState: PumpManager.RawStateValue) {
        self.init(state: M640GKitPumpManagerState(rawValue: rawState))
    }

    private let log = DanaLogger(category: "M640GKitPumpManager")
    ...
    private var doseReporter: M640GKitDoseProgressReporter?
...
extension M640GKitPumpManager: PumpManager {
    ...
    public static var onboardingSupportedMaximumBolusVolumes: [Double] {
        M640GKitPumpManager.onboardingSupportedBolusVolumes
    }
    ...
    public var supportedBasalRates: [Double] {
        M640GKitPumpManager.onboardingSupportedBasalRates
    }
    ...
    public var maximumBasalScheduleEntryCount: Int {
        M640GKitPumpManager.onboardingMaximumBasalScheduleEntryCount
    }
    ...
    private func status(_ state: M640GKitPumpManagerState) -> LoopKit.PumpManagerStatus {
    ...
    public func enactBolus(
        ...
        guard state.bolusState == .noBolus else {
            ...
            completion(.deviceState(M640GKitPumpManagerError.pumpIsBusy))
            return
        }
            ...
            self.bluetooth.ensureConnected { result in
                ...
                case .success:
                    guard !self.state.isPumpSuspended else {
                        ...
                        completion(PumpManagerError.deviceState(M640GKitPumpManagerError.pumpSuspended))
                        return
                    }
                    ...
                    do {
                        ...
                        self.doseReporter = M640GKitDoseProgressReporter(total: units)
                        ...
                        completion(PumpManagerError.connection(M640GKitPumpManagerError.unknown(error.localizedDescription)))
                    }
                default:
                    ...
                    completion(PumpManagerError.connection(M640GKitPumpManagerError.noConnection(result)))
                    return
                }
            }
        }
        ...
        delegateQueue.async {
            ...
            self.bluetooth.ensureConnected { result in
                ...
                default:
                    ...
                    completion(.failure(PumpManagerError.connection(M640GKitPumpManagerError.noConnection(result))))
                    return
                }
            }
        }
    ...
    private func doCancelAction(oldBolusState: BolusState, completion: @escaping (PumpManagerResult<DoseEntry?>) -> Void) {
        do {
            ...
            completion(.failure(PumpManagerError.communication(M640GKitPumpManagerError.unknown(error.localizedDescription))))
        }
    }
            ...
            self.bluetooth.ensureConnected { result in
                ...
                case .success:
                    ...
                    do {
                        ...
                        completion(PumpManagerError.communication(M640GKitPumpManagerError.unknown(error.localizedDescription)))
                    }
                default:
                    self.log.error("Connection error")
                    completion(PumpManagerError.connection(M640GKitPumpManagerError.noConnection(result)))
                ...
                case .success:
                    do {
                        ...
                        guard result.success else {
                            ...
                            completion(PumpManagerError.configuration(M640GKitPumpManagerError.failedSuspensionAdjustment))
                            return
                        }
    ...
    public func syncBasalRateSchedule(
        ...
        delegateQueue.async {
            ...
            self.bluetooth.ensureConnected { result in
                ...
                case .success:
                    do {
                        let basal = M640GKitPumpManagerState.convertBasal(scheduleItems)
                        let packet =
                        ...
                        guard result.success else {
                            ...
                            completion(.failure(PumpManagerError.configuration(M640GKitPumpManagerError.failedBasalAdjustment)))
                            return
                        }
                        ...
                        guard let schedule = DailyValueSchedule<Double>(dailyItems: scheduleItems) else {
                            ...
                            completion(.failure(PumpManagerError.configuration(M640GKitPumpManagerError.failedBasalGeneration)))
                            return
                        }
                        ...
                        completion(.failure(
                            PumpManagerError
                                .communication(M640GKitPumpManagerError.unknown(error.localizedDescription))
                        ))
                    }
                default:
                    self.log.error("Connection error")
                ...
                case .success:
                    do {
                        ...
                        guard basalResult.success else {
                            ...
                            completion(.failure(
                                PumpManagerError
                                    .configuration(M640GKitPumpManagerError.unknown("Pump refused to send basal rates back"))
                            ))
                            return
                        }
                        ...
                        guard bolusResult.success else {
                            ...
                            completion(.failure(
                                PumpManagerError
                                    .configuration(M640GKitPumpManagerError.unknown("Pump refused to send bolus step back"))
                            ))
                            return
                        }
                ...
                case .success:
                    do {
                        ...
                        guard result.success else {
                            ...
                            completion(PumpManagerError.configuration(M640GKitPumpManagerError.failedTimeAdjustment))
                            return
                        }
...
extension M640GKitPumpManager: AlertSoundVendor {
...
public extension M640GKitPumpManager {
...
public extension M640GKitPumpManager {
    ...
    func notifyStateDidChange() {
        DispatchQueue.main.async {
            ...
            self.oldState = M640GKitPumpManagerState(rawValue: self.state.rawValue)
        }
    }
