...
public class M640GKitPumpState: RawRepresentable {
    ...
    public var pumpName: String {
        ...
        if model == "MD8301" {
            return "M640GKit Nano 300U"
        } else if model == "INVALID" {
            return "M640GKit Nano UNKNOWN"
        } else {
            return "M640GKit Nano 200U"
        }
    }
