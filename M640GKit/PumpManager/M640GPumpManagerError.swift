...
public enum M640GPumpManagerError: Error {
    case noRileyLink
...
extension M640GPumpManagerError: LocalizedError {
    public var errorDescription: String? {
        ...
        case .insulinTypeNotConfigured:
            return LocalizedString("Insulin Type is not configured", comment: "Error description for M640GPumpManagerError.insulinTypeNotConfigured")
        case .noDate:
            return nil
    ...
    public var recoverySuggestion: String? {
        ...
        case .insulinTypeNotConfigured:
            return LocalizedString("Go to pump settings and select insulin type", comment: "Recovery suggestion for M640GPumpManagerError.insulinTypeNotConfigured")
        case .tuneFailed(let error):
