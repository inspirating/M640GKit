...
public struct M640GPumpManagerState: RawRepresentable, Equatable {
    ...
    public var rawValue: RawValue {
        var value: [String : Any] = [
            ...
            "version": M640GPumpManagerState.version,
...
extension M640GPumpManagerState: CustomDebugStringConvertible {
    public var debugDescription: String {
        return [
            "## M640GPumpManagerState",
            "isOnboarded: \(isOnboarded)",
