...
class NotificationManager {
    private static let logger = M640GKitLogger(category: "NotificationManager")

    private enum Identifiers: String {
        case patchExpiredNotification = "com.nightscout.M640GKit.patch-expired"
        case patchDailyMaxNotification = "com.nightscout.M640GKit.patch-daily-limit"
        case patchHourlyMaxNotification = "com.nightscout.M640GKit.patch-hourly-limit"
        case occlusionNotification = "com.nightscout.M640GKit.patch-occlussion"
        case patchFaultNotification = "com.nightscout.M640GKit.patch-fault"
        case reservoirEmptyNotification = "com.nightscout.M640GKit.patch-empty"
    }
