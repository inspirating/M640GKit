...
public class M640GPumpOps: PumpOps {
...
extension M640GPumpOps: PumpOpsSessionDelegate {
    ...
    public func pumpOpsSession(_ session: PumpOpsSession, didChange state: PumpState) {
        ...
        NotificationCenter.default.post(
            ...
            object: self,
            userInfo: [M640GPumpOps.notificationPumpStateKey: pumpState]
        )
    }
}


extension M640GPumpOps: CustomDebugStringConvertible {
