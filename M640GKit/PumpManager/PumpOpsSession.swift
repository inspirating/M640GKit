...
extension PumpOpsSession {
    ...
    private func isPumpResponding() -> Bool {
        do {
            let _: GetPumpModelCarelinkMessageBody = try messageSender.getResponse(to: PumpMessage(pumpID: settings.pumpID, type: .getPumpModel), responseType: .getPumpModel, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 1)
            return true
        } catch {
            return false
        }
    ...
    private func wakeup(_ duration: TimeInterval = TimeInterval(minutes: 1)) throws {
        ...
        do {
            ...
            let _: PumpAckMessageBody = try messageSender.getResponse(to: longPowerMessage, responseType: .pumpAck, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
        } catch let error as PumpOpsError {
...
extension PumpOpsSession {
    ...
    public func getPumpModel(usingCache: Bool = true) throws -> PumpModel {
        ...
        try wakeup()
        let body: GetPumpModelCarelinkMessageBody = try messageSender.getResponse(to: PumpMessage(pumpID: settings.pumpID, type: .getPumpModel), responseType: .getPumpModel, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
    ...
    public func getPumpFirmwareVersion() throws -> String {
        ...
        try wakeup()
        let body: GetPumpFirmwareVersionMessageBody = try messageSender.getResponse(to: PumpMessage(pumpID: settings.pumpID, type: .readFirmwareVersion), responseType: .readFirmwareVersion, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
    ...
    public func getBatteryStatus() throws -> GetBatteryCarelinkMessageBody {
        try wakeup()
        return try messageSender.getResponse(to: PumpMessage(pumpID: settings.pumpID, type: .getBattery), responseType: .getBattery, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
    }
    ...
    internal func getPumpStatus() throws -> ReadPumpStatusMessageBody {
        try wakeup()
        return try messageSender.getResponse(to: PumpMessage(pumpID: settings.pumpID, type: .readPumpStatus), responseType: .readPumpStatus, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
    }
    ...
    public func getSettings() throws -> ReadSettingsCarelinkMessageBody {
        try wakeup()
        return try messageSender.getResponse(to: PumpMessage(pumpID: settings.pumpID, type: .readSettings), responseType: .readSettings, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
    }
    ...
    public func getTime() throws -> DateComponents {
        try wakeup()
        let response: ReadTimeCarelinkMessageBody = try messageSender.getResponse(to: PumpMessage(pumpID: settings.pumpID, type: .readTime), responseType: .readTime, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
    ...
    public func getBasalSchedule(for profile: BasalProfile = .standard) throws -> BasalSchedule? {
        ...
        while (!isFinished) {
            let body: DataFrameMessageBody = try messageSender.getResponse(to: message, responseType: profile.readMessageType, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
    ...
    public func getOtherDevicesIDs() throws -> ReadOtherDevicesIDsMessageBody {
        ...
        return try messageSender.getResponse(to: PumpMessage(pumpID: settings.pumpID, type: .readOtherDevicesIDs), responseType: .readOtherDevicesIDs, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
    }
    ...
    public func getOtherDevicesEnabled() throws -> Bool {
        ...
        let response: ReadOtherDevicesStatusMessageBody = try messageSender.getResponse(to: PumpMessage(pumpID: settings.pumpID, type: .readOtherDevicesStatus), responseType: .readOtherDevicesStatus, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
    ...
    public func getRemoteControlIDs() throws -> ReadRemoteControlIDsMessageBody {
        ...
        return try messageSender.getResponse(to: PumpMessage(pumpID: settings.pumpID, type: .readRemoteControlIDs), responseType: .readRemoteControlIDs, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
    }
}
...
extension PumpOpsSession {
    ...
    public func getRemainingInsulin() throws -> (units: Double, clock: DateComponents) {
        ...
        let reservoir: ReadRemainingInsulinMessageBody = try messageSender.getResponse(to: PumpMessage(pumpID: settings.pumpID, type: .readRemainingInsulin), responseType: .readRemainingInsulin, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
...
extension PumpOpsSession {
    ...
    private func runCommandWithArguments<T: MessageBody>(_ message: PumpMessage, responseType: MessageType = .pumpAck, retryCount: Int = 3, testingFailureMode: CommandTestingFailureMode? = nil) throws -> T {
        do {
            ...
            let _: PumpAckMessageBody = try messageSender.getResponse(to: shortMessage, responseType: .pumpAck, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
        } catch let error as PumpOpsError {
            throw PumpCommandError.command(error)
        }
        ...
        do {
            ...
            let response: T = try messageSender.getResponse(to: message, responseType: responseType, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: retryCount)
    ...
    public func setTempBasal(_ unitsPerHour: Double, duration: TimeInterval) -> Result<Bool,PumpCommandError> {
        ...
        do {
            let _: PumpAckMessageBody = try messageSender.getResponse(to: message, responseType: .pumpAck, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 1)
        ...
        do {
            let response: ReadTempBasalCarelinkMessageBody = try messageSender.getResponse(to: PumpMessage(pumpID: settings.pumpID, type: .readTempBasal), responseType: .readTempBasal, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
    ...
    public func setTime(_ generator: () -> DateComponents) throws {
        ...
        do {
            ...
            let _: PumpAckMessageBody = try messageSender.getResponse(to: message, responseType: .pumpAck, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
...
extension PumpOpsSession {
    ...
    public func changeWatchdogMarriageProfile(_ watchdogID: Data) throws {
        ...
        guard let packet = M640GPacket(encodedData: encodedData) else {
        ...
        for freq in frequencies {
            ...
            for _ in 1...tries {
                ...
                if  let rfPacket = rfPacket,
                    let pkt = M640GPacket(encodedData: rfPacket.data),
    ...
    private func getHistoryPage(_ pageNum: Int) throws -> Data {
        ...
        while(expectedFrameNum == curResp.frameNumber) {
            ...
            if !curResp.lastFrame {
                curResp = try messageSender.getResponse(to: msg, responseType: .getHistoryPage, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
            } else {
...
extension PumpOpsSession {
    ...
    public func getGlucoseHistoryEvents(since startDate: Date) throws -> [TimestampedGlucoseEvent] {
        ...
        let currentGlucosePage: ReadCurrentGlucosePageMessageBody = try messageSender.getResponse(to: PumpMessage(pumpID: settings.pumpID, type: .readCurrentGlucosePage), responseType: .readCurrentGlucosePage, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
    ...
    private func getGlucosePage(_ pageNum: UInt32) throws -> Data {
        ...
        while(expectedFrameNum == curResp.frameNumber) {
            ...
            let msg = PumpMessage(pumpID: settings.pumpID, type: .pumpAck)
            if !curResp.lastFrame {
                curResp = try messageSender.getResponse(to: msg, responseType: .getGlucosePage, repeatCount: 0, timeout: M640GPumpMessageSender.standardPumpResponseWindow,  retryCount: 3)
            } else {
                try messageSender.send(msg)
                break
            }
