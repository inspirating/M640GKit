...
class M640GPacketTests: XCTestCase {
    ...
    func testDecode4b6b() {
        ...
        let packet = M640GPacket(encodedData: input)
    ...
    func testDecode4b6bWithBadData() {
        let packet = M640GPacket(encodedData: Data(hexadecimalString: "0102030405")!)
        XCTAssertNil(packet)
    }
