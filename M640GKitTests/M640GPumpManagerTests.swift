...
class M640GPumpManagerTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        let state = M640GPumpManagerState(
            isOnboarded: true,
            useMySentry: true,
            pumpColor: .blue,
            pumpID: pumpID,
        ...
        pumpManager = M640GPumpManager(state: state, rileyLinkDeviceProvider: rlProvider, pumpOps: pumpOps, dateGenerator: dateGenerator)
