...
extension M640GKitPumpManager: PumpManagerUI {
    ...
    public func deliveryUncertaintyRecoveryViewController(
        ...
        return M640GKitUICoordinator(pumpManager: self, colorPalette: colorPalette, allowDebugFeatures: allowDebugFeatures)
    }
    ...
    public static func createHUDView(rawValue: [String: Any]) -> BaseHUDView? {
        M640GKitHUDProvider.createHUDView(rawValue: rawValue)
    }

    public static var onboardingImage: UIImage? {
        UIImage(named: "nano200", in: Bundle(for: M640GKitHUDProvider.self), compatibleWith: nil)
    }

    public var smallImage: UIImage? {
        UIImage(
            named: state.pumpName.contains("300u") ? "nano300" : "nano200",
            in: Bundle(for: M640GKitHUDProvider.self),
            compatibleWith: nil
        )
    }
