...
extension M640GKitPumpManager: PumpManagerUI {
    ...
    public static var onboardingImage: UIImage? {
        UIImage(named: "danai", in: Bundle(for: M640GKitHUDProvider.self), compatibleWith: nil)
    }

    public var smallImage: UIImage? {
        UIImage(named: state.getDanaPumpImageName(), in: Bundle(for: M640GKitHUDProvider.self), compatibleWith: nil)
    }
