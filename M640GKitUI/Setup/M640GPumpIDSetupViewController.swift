//
//  M640GPumpIDSetupViewController.swift
//  Loop
//
...
class M640GPumpIDSetupViewController: SetupTableViewController {
    ...
    var pumpManagerState: M640GPumpManagerState? {
        get {
            guard
                let navVC = navigationController as? M640GPumpManagerSetupViewController,
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let cell = tableView.cellForRow(at: indexPath) as? RegionAndColorPickerTableViewCell {
            ...
            if pumpRegionCode == nil {
                pumpRegionCode = M640GPumpIDSetupViewController.regionRows[0]
            }
            if pumpColor == nil {
                pumpColor = M640GPumpIDSetupViewController.colorRows[0]
            }
        }
...
extension M640GPumpIDSetupViewController: UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        ...
        case .region:
            return M640GPumpIDSetupViewController.regionRows[row].rawValue
        case .color:
            return M640GPumpIDSetupViewController.colorRows[row].rawValue
        }
    }
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        switch PickerViewComponent(rawValue: component)! {
        case .region:
            pumpRegionCode = M640GPumpIDSetupViewController.regionRows[row]
        case .color:
            pumpColor = M640GPumpIDSetupViewController.colorRows[row]
        }
    }
    ...
    func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int {
        switch PickerViewComponent(rawValue: component)! {
        case .region:
            return M640GPumpIDSetupViewController.regionRows.count
        case .color:
            return M640GPumpIDSetupViewController.colorRows.count
        }
    }
}


extension M640GPumpIDSetupViewController: UITextFieldDelegate {
...
extension M640GPumpIDSetupViewController: PumpOpsDelegate {
