//
//  M640GPumpSentrySetupViewController.swift
//  Loop
//
...
class M640GPumpSentrySetupViewController: SetupTableViewController {
    ...
    private func listenForPairing() {
        guard let pumpManager = pumpManager else {
            ...
            lastError = PumpManagerError.connection(M640GPumpManagerError.noRileyLink)
            return
        }
