...
class M640GKitRefillReservoirCannulaViewModel: ObservableObject {
    ...
    private let processQueue = DispatchQueue(label: "M640GKit.prime.processQueue")

    init(pumpManager: M640GKitPumpManager?, cannulaOnly: Bool) {
...
extension M640GKitRefillReservoirCannulaViewModel: DoseProgressObserver {
