...
class M640GKitScanViewModel: ObservableObject {
    ...
    init(_ pumpManager: M640GKitPumpManager? = nil, nextStep: @escaping () -> Void) {
...
extension M640GKitScanViewModel: StateObserver {
    ...
    func stateDidUpdate(_: M640GKitPumpManagerState, _: M640GKitPumpManagerState) {
        // Not needed
    }
}
