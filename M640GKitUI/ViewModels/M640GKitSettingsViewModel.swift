...
class M640GKitSettingsViewModel: ObservableObject {
    ...
    private(set) var pumpManager: M640GKitPumpManager?
    private var didFinish: (() -> Void)?
    private(set) var userOptionsView: M640GKitUserSettingsView
    private(set) var refillView: M640GKitRefillReservoirAndCannulaView
    ...
    public init(_ pumpManager: M640GKitPumpManager?, _ didFinish: (() -> Void)?) {
        self.pumpManager = pumpManager
        self.didFinish = didFinish

        userOptionsView = M640GKitUserSettingsView(viewModel: M640GKitUserSettingsViewModel(self.pumpManager))
        refillView =
            M640GKitRefillReservoirAndCannulaView(viewModel: M640GKitRefillReservoirCannulaViewModel(
...
extension M640GKitSettingsViewModel: StateObserver {
