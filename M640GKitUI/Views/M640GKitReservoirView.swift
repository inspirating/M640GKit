...
public final class M640GKitReservoirView: LevelHUDView, NibLoadable {
    ...
    public class func instantiate() -> M640GKitReservoirView {
        nib().instantiate(withOwner: nil, options: nil)[0] as! M640GKitReservoirView
    }
