...
struct M640GPumpSettingsView: View {

    @Environment(\.guidanceColors) private var guidanceColors
    @Environment(\.insulinTintColor) var insulinTintColor

    @ObservedObject var viewModel: M640GPumpSettingsViewModel
    ...
    init(viewModel: M640GPumpSettingsViewModel, supportedInsulinTypes: [InsulinType], handleRileyLinkSelection: @escaping (RileyLinkDevice) -> Void, rileyLinkListDataSource: RileyLinkListDataSource) {
    ...
    var body: some View {
        List {
            ...
            Section(header: Text(LocalizedString("Status", comment: "The title of the status section in M640GPumpManager settings"))) {
            ...
            Section(header: Text(LocalizedString("Configuration", comment: "The title of the configuration section in M640GPumpManager settings")))
            {
            ...
            Section(header: Text(LocalizedString("Details", comment: "The title of the details section in M640GPumpManager settings")))
            {
    ...
    var reservoirStatus: some View {
        VStack(alignment: .leading, spacing: 5) {
            ...
            {
                HStack {
                    M640GReservoirView(filledPercent: reservoirPercent, fillColor: reservoirColor(for: reservoirLevelHighlightState))
