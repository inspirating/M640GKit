//
//  M640GPumpSettingsViewModel.swift
//  M640GKitUI
//
...
enum M640GSettingsViewAlert: Identifiable {
...
class M640GPumpSettingsViewModel: ObservableObject {
    ...
    @Published var activeAlert: M640GSettingsViewAlert?
...
extension M640GPumpSettingsViewModel: PumpManagerStatusObserver {
...
extension M640GPumpSettingsViewModel: M640GPumpManagerStateObserver {
    func didUpdatePumpManagerState(_ state: M640GKit.M640GPumpManagerState) {
