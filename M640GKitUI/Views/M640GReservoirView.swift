...
public final class M640GReservoirView: LevelHUDView, NibLoadable {
    ...
    public class func instantiate() -> M640GReservoirView {
        nib().instantiate(withOwner: nil, options: nil)[0] as! M640GReservoirView
    }
