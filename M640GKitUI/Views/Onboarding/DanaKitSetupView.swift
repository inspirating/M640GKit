        ...
        VStack(alignment: .leading) {
            List {
                Section(header: SectionHeader(label: LocalizedString("Choose your Dana pump", comment: "Onboarding subheader"))) {
                    CheckmarkListItem(
                        title: Text(LocalizedString("Dana-i", comment: "dana-i option text for M640GKitSetupView")),
                    ...
                    CheckmarkListItem(
                        title: Text(LocalizedString("DanaRS-v3", comment: "danaRS v3 option text for M640GKitSetupView")),
                        description: Text(LocalizedString(
...
#Preview {
    M640GKitSetupView(nextAction: { _ in })
}
