...
struct M640GKitScanView: View {
    @Environment(\.isPresented) var isPresented
    @Environment(\.dismissAction) private var dismiss

    @ObservedObject var viewModel: M640GKitScanViewModel
    ...
    var body: some View {
        ...
        .navigationTitle(LocalizedString("Pairing", comment: "Title for M640GKitScanView"))
        .toolbar {
...
#Preview {
    M640GKitScanView(viewModel: M640GKitScanViewModel(nextStep: {}))
}
