...
struct M640GKitUserSettingsView: View {
    @ObservedObject var viewModel: M640GKitUserSettingsViewModel
...
#Preview {
    M640GKitUserSettingsView(viewModel: M640GKitUserSettingsViewModel(nil))
}
